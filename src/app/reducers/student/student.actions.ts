...
export enum StudentActionTypes {
  ...
  GetSuccStudent ='[Student] succ Student',
  GetFailStudent ='[Student] fail Student'
}
...
export class GetSuccStudent implements Action{
  readonly type = StudentActionTypes.GetSuccStudent;
  constructor(public payload:any){}
}

export class GetFailStudent implements Action{
  readonly type = StudentActionTypes.GetFailStudent;
  constructor(public payload:any){}
}
